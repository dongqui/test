import { ServerAnimation, ServerAnimationLayer } from './../../types/common/index';
import { applyMocapToModelSocket } from './../../actions/LP/lpNodeAction';
import { find, cloneDeep } from 'lodash';
import { select, put, SagaReturnType, call, take, all, takeLatest } from 'redux-saga/effects';
...
function* handleApplyMocapToModelRequest(action: ReturnType<typeof lpNodeActions.applyMocapToModelSocket.request>) {
  ...
  if (!draggedNode || !dropNode || !targetAsset || !targetRetargetMap || !draggedNode?.mocapData) {
    return;
  }
