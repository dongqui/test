...
// function* handleApplyMocapToModelRequest(action: ReturnType<typeof lpNodeActions.dropMocapOnModel>) {
//   const { lpNode, plaskProject, animationData }: RootState = yield select();
//   const { draggedNode, nodes } = lpNode;
//   const { assetList } = plaskProject;
//   const { retargetMaps } = animationData;
...
// function* handleApplyMocapToModelSend(action: ReturnType<typeof lpNodeActions.applyMocapToModelSocket.send>) {
//   // Socket.emit('library', {
//   //   type: 'apply-mocap-to-model',
//   //   scenesLibraryId: action.payload.scenesLibraryId,
//   // })
// }

// function* handleApplyMocapToModelReceive(action: ReturnType<typeof lpNodeActions.applyMocapToModelSocket.receive>) {
//   try {
//     const { lpNode }: RootState = yield select();
//     const { draggedNode, nodes } = lpNode;
//     const { modelId, mocapNode, assetId } = action.payload;
...
//     takeLatest(getType(lpNodeActions.applyMocapToModelSocket.send), handleApplyMocapToModelSend),
