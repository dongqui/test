...
//   var a = Vector3.Distance(bone2Pos, bonePos);
//   var b = Vector3.Distance(this['_bone2'].children[0].getAbsolutePosition(this.mesh), bone2Pos);
