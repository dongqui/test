...
export const Dopesheet = React.memo<SvgIconProps>(({ size = 24, fillColor = '#000', viewBox = '0 0 24 24', style }) => (
  <svg width={size} height={size} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={style} viewBox={viewBox}>
    <defs>
      <path d="M2.75 4.5a2 2 0 100-4 2 2 0 000 4zm0-1a1 1 0 100-2 1 1 0 000 2z" id="Dope_sheet_svg__a" />
      <path d="M2.25 4.5a2 2 0 100-4 2 2 0 000 4zm0-1a1 1 0 100-2 1 1 0 000 2z" id="Dope_sheet_svg__c" />
      <path d="M2.25 4.5a2 2 0 100-4 2 2 0 000 4zm0-1a1 1 0 100-2 1 1 0 000 2z" id="Dope_sheet_svg__e" />
    </defs>
    <g fill="none" fillRule="evenodd">
      ...
      <path d="M10.25 4.5a2 2 0 100-4 2 2 0 000 4zm0-1a1 1 0 100-2 1 1 0 000 2z" fill="#398BFF" />
      ...
      <path d="M17.25 4.5a2 2 0 100-4 2 2 0 000 4zm0-1a1 1 0 100-2 1 1 0 000 2z" fill="#398BFF" />
