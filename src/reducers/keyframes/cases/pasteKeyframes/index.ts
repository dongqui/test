...
const dragDropKeyframes = (state: KeyframesState, payload: Paste) => {
  ...
  const service = new KeyframeService(state, payload, layerKeyframeRepo, boneKeyframeRepo, propertyKeyframeRepo);
