...
export type KeyframesUnion = Pick<KeyframesState, 'layerTrack'> | Pick<KeyframesState, 'boneTrackList'> | Pick<KeyframesState, 'propertyTrackList'>;
export type AllKeyframes = Pick<KeyframesState, 'layerTrack' | 'boneTrackList' | 'propertyTrackList'>;
...
export type AllSelectedKeyframes = Pick<KeyframesState, 'selectedLayerKeyframes' | 'selectedBoneKeyframes' | 'selectedPropertyKeyframes'>;
