 ...
 *
 */
const fnExportModelToGltf = async (props: FnExportModelToGltf) => {
  ...
  exporter.parse(
    ...
    (res) => {
      ...
      a.download = `${modelName.slice(0, -4)}.gltf`;
      a.href = objURL;
      a.click();
    },
    options,
...
export default fnExportModelToGltf;
